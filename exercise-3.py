...
class Student:
    ...
    #this is the String representation of the student
    def __str__(self):
...
# this is for the Student Management System
class StudentManagementSystem:
    def __init__(self, master):
        ...
        # serch_label will disiplay Search label and entry field
    ...
    #view an individual student record
